<template>
    <div class="user">
        <div class="header">
            ...
            <div class="right">
                <button v-tippy="`Add User`" type="button" @click="user.isShow = true">Add User</button>
            </div>
        </div>
        ...
        <template #body>
            <form @submit.prevent="addUser">
                <div class="mb-3">
                    ...
                    <Field name="firstName" as="input" type="text" id="firstName" class="form-control" placeholder="Enter First Name"
                        rules="required|nospace" />
                    <ErrorMessage name="firstName" class="text-danger mt-2" />
                </div>
                <div class="mb-3">
                    <label for="lastName" class="form-label">Last Name</label>
                    <Field name="lastName" as="input" type="text" id="lastName" class="form-control" placeholder="Enter Last Name"
                        rules="required|nospace" />
                ...
                <div class="mb-3">
                    ...
                    <Field name="email" as="input" type="text" id="email" class="form-control"
                        placeholder="Enter email" rules="required|nospace|email" />
                ...
                <div class="mb-3">
                    ...
                    <Field name="password" as="input" type="password" id="password" class="form-control"
                        placeholder="Enter password" rules="required|nospace" />
                ...
                <div class="mb-3">
                    ...
                    <Field name="role" as="input" type="number" id="role" class="form-control"
                        placeholder="Enter Phone Number" rules="required|nospace|min:10|max:10" />
